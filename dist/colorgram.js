(function (global, factory) {
  ...
  (global = global || self, factory(global.Colorgram = {}));
  ...
  function getPixels(stats, width, proportional, channels) {
      ...
      if (channels === void 0) { channels = exports.Channels.RGBAlpha; }
      var step;
      var k;
      var i;
      var current;
      ...
      for (i = 0; i < stats.length; i++) {
          ...
          while (current < end) {
              ...
              data[k++] = stats[i][1];
              data[k++] = stats[i][2];
              if (channels === exports.Channels.RGBAlpha) {
                  data[k++] = 255;
              }
              current += channels;
          }
